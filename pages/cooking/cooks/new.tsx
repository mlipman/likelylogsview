...
export default function NewCook() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [weeksResponse, recipesResponse] = await Promise.all([
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Create a new cooking session</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-6">
              ...
              {selectedRecipe.url && (
                <a
                  ...
                  className="text-sm text-red-600 hover:text-red-800 underline mb-2 block"
                >
          ...
          <div className="flex justify-between items-center">
            <Link href="/cooking/cooks" className="px-4 py-2 text-gray-600 hover:text-gray-800">
              ← Cancel
            </Link>
